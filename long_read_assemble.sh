...
CONFIG_PATH="/work/raechill/clownfish_data/long_reads.config"
...
/work/raechill/MaSuRCA-3.2.4/bin/mega_reads_assemble_cluster.sh -Pb 300000000 -q all.q -G 0 -C 30 -t 16 -e $ESTIMATED_GENOME_SIZE -m work1 -p data/paired_end -a /work/raechill/MaSuRCA-3.2.4/bin/../CA8/Linux-amd64/bin -o "   cgwErrorRate=0.15" -B 17 -D 0.029
